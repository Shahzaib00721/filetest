...
const restaurants = [
  {
    ...
    discount: '20% off',
    deliveryType: 'Fast',
    imageSrc: '/img14 (2).png', // Use your image path
    logoSrc: '/sm5.png', // Use your logo path
    status: 'Opens Now',
  ...
  return (
    <div className="max-w-7xl  mx-auto px-4 py-10 bg-white md:px-20 ">
      ...
      <div className="flex justify-center mt-20">
        <button className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-orange-500 hover:to-yellow-400 transition text-white font-medium px-6 py-2 rounded shadow-md focus:outline-none focus:ring-2 focus:ring-orange-400 flex items-center space-x-2">
          <span>View All</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
